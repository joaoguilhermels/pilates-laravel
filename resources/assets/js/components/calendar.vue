        ...
        $('#fullcalendar').fullCalendar({
            ...
            eventClick: function(calEvent, jsEvent, view) {
                $('#modal').on('show.bs.modal', function (event) {
                    ...
                    modal.find('.modal-body').html(
                        "Professional: " + calEvent.professional_name + "(" + calEvent.professional_id + ")" +
                        "<br>Room: " + calEvent.room_name + "(" + calEvent.room_id + ")" +
                        "<br>Class Type: " + calEvent.title + "(" + calEvent.class_type_id + ")"
                    );
                });
