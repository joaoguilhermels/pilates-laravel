...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div class="mb-8">
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Create New Extra Class</h1>
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Schedule an additional class or session for your studio.</p>
      </div>
      ...
      <div>
        ...
        <div class="mt-1">
          <textarea name="observation" id="observation" rows="3" 
                    ...
                    placeholder="Any additional notes for this extra class...">{{ old('observation') }}</textarea>
        </div>
        @error('observation')
          <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
        @enderror
