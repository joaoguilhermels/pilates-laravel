...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div class="mb-8">
    <div class="flex items-center justify-between">
      ...
      <a href="{{ route('calendar') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
  ...
  @if($classTypes->count() == 0)
    ...
    <div class="bg-yellow-50 border border-yellow-200 rounded-md p-4">
      <div class="flex">
        ...
        <div class="ml-3">
          <h3 class="text-sm font-medium text-yellow-800">No Trial Classes Available</h3>
          ...
          <div class="mt-4">
            <a href="{{ route('classes.index') }}" class="text-sm font-medium text-yellow-800 hover:text-yellow-600">
    ...
    <div class="bg-white shadow rounded-lg">
      <form action="{{ route('schedules.trial.store') }}" method="POST" class="space-y-6 p-6">
        ...
        <div class="bg-yellow-50 rounded-lg p-4">
          <h3 class="text-lg font-medium text-yellow-900 mb-4">New Client Information</h3>
        ...
        <!-- Class Selection -->
        <div>
          <label for="class_type_id" class="block text-sm font-medium text-gray-700">Trial Class Type *</label>
          <div class="mt-1">
        ...
        <div id="professional-section" class="hidden">
          <label for="professional_id" class="block text-sm font-medium text-gray-700">Instructor *</label>
          <div class="mt-1">
