...
<div>
  ...
  <div class="mt-1">
    <select name="client_id" id="client_id" 
            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('client_id') border-red-300 @enderror" 
            required>
...
<div>
  <label for="class_type_id" class="block text-sm font-medium text-gray-700">Class Type *</label>
  <div class="mt-1">
