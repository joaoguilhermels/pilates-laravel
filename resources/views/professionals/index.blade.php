...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <x-smart-breadcrumbs :items="[
    ['title' => __('app.professionals'), 'url' => '']
  ]" />
  
  <!-- Page Header -->
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">{{ __('app.professionals') }}</h1>
      <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">{{ __('app.manage_studio_instructors_staff') }}</p>
    </div>
  ...
  @if (count($professionals) == 0)
    ...
    <div class="text-center py-12">
      ...
      <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('app.no_professionals_found') }}</h3>
      <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('app.get_started_add_first_professional') }}</p>
      <div class="mt-6">
