...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div class="mb-8">
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Create New Professional</h1>
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Add a new instructor or staff member to your studio.</p>
      </div>
