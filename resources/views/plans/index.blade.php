...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div class="mb-8">
    <div class="sm:flex sm:items-center sm:justify-between">
      <div>
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">{{ __('app.membership_plans') }}</h1>
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">{{ __('app.manage_studio_plans') }}</p>
      </div>
  ...
  @if(count($plans) == 0)
    ...
    <div class="text-center py-12">
      ...
      <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('app.no_plans') }}</h3>
      <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('app.get_started_first_plan') }}</p>
      <div class="mt-6">
