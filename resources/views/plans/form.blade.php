...
<div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
  <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Plan Structure</h3>
  
  <!-- Sessions per Period -->
  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
    <div>
      <label for="times" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Number of Sessions *</label>
      <div class="mt-1">
    ...
    <div>
      <label for="times_type" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Per *</label>
      <div class="mt-1">
  ...
  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 mt-4">
    <div>
      <label for="duration" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Plan Duration *</label>
      <div class="mt-1">
    ...
    <div>
      <label for="duration_type" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Duration Unit *</label>
      <div class="mt-1">
...
<div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
  ...
  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
    ...
    <div>
      <label for="price_type" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Price Per *</label>
      <div class="mt-1">
...
<div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
  <h3 class="text-lg font-medium text-blue-900 dark:text-blue-100 mb-2">Plan Summary</h3>
  <div id="plan-summary" class="text-sm text-blue-700 dark:text-blue-200">
