...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div class="mb-8">
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="mt-1 text-sm text-gray-600">Add a new membership plan to your studio offerings.</p>
      </div>
  ...
  <div class="bg-white shadow rounded-lg">
    <form action="{{ route('plans.store') }}" method="POST" class="space-y-6 p-6">
      @csrf
      @include('plans.form', ['submitButtonText' => 'Create Plan', 'plan' => $plan, 'classTypes' => $classTypes])
    </form>
  </div>
</div>
@endsection
