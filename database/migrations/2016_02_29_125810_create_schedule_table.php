...
class CreateScheduleTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('schedules', function (Blueprint $table) {
            ...
            $table->integer('client_id')->unsigned()->index()->references('id')->on('clients');
            ...
            $table->integer('room_id')->unsigned()->index()->references('id')->on('rooms');

            $table->integer('class_type_id')->unsigned()->index()->references('id')->on('class_types');

            $table->integer('professional_id')->unsigned()->index()->references('id')->on('professionals');

            $table->integer('class_type_status_id')->unsigned()->index()->references('id')->on('class_type_statuses');
